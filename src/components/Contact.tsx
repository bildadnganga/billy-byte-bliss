              ...
              <CardContent>
                <div className="space-y-6">
                  ...
                  <div className="flex gap-4">
                    {[
                      { icon: Github, href: "#", label: "GitHub", handle: "@billy-dev" },
                      { icon: Linkedin, href: "#", label: "LinkedIn", handle: "/in/billy-engineer" },
                      { icon: Twitter, href: "#", label: "Twitter", handle: "@billy_codes" }
